...
pool_thread_runner :: proc(t: ^Thread) {
	...
	if pool.thread_init_proc != nil {	                            // new
		pool.thread_init_proc(t.user_index, pool.thread_init_data)  // new
	}	                                                            // new
	...
	if pool.thread_fini_proc != nil {                               // new
		pool.thread_fini_proc(t.user_index, pool.thread_fini_data)  // new
	}                                                               // new
